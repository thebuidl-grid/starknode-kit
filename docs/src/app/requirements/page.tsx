    ...
    <div className="prose prose-lg max-w-none">
      ...
      <div className="not-prose my-6">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">CPU</td>
              <td className="px-6 py-4 text-sm">4+ cores</td>
              <td className="px-6 py-4 text-sm">Intel i3/i5 or AMD equivalent. Avoid Celeron.</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">RAM</td>
              <td className="px-6 py-4 text-sm">32 GB</td>
              <td className="px-6 py-4 text-sm">Minimum 16GB, 32GB recommended for comfort</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">Storage</td>
              <td className="px-6 py-4 text-sm">2+ TB NVMe SSD</td>
              <td className="px-6 py-4 text-sm">Must have DRAM cache, no QLC NAND</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">Network</td>
              <td className="px-6 py-4 text-sm">100+ Mbps</td>
              <td className="px-6 py-4 text-sm">Stable connection, unlimited data preferred</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">Power</td>
              <td className="px-6 py-4 text-sm">24/7 uptime</td>
              <td className="px-6 py-4 text-sm">UPS recommended for validators</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="not-prose my-6">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">Ethereum (Geth)</td>
              <td className="px-6 py-4 text-sm">~1.2 TB</td>
              <td className="px-6 py-4 text-sm">~150 GB/year</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">Ethereum (Reth)</td>
              <td className="px-6 py-4 text-sm">~900 GB</td>
              <td className="px-6 py-4 text-sm">~120 GB/year</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">Lighthouse</td>
              <td className="px-6 py-4 text-sm">~200 GB</td>
              <td className="px-6 py-4 text-sm">~50 GB/year</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">Prysm</td>
              <td className="px-6 py-4 text-sm">~250 GB</td>
              <td className="px-6 py-4 text-sm">~60 GB/year</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">Juno (Starknet)</td>
              <td className="px-6 py-4 text-sm">~300 GB</td>
              <td className="px-6 py-4 text-sm">~100 GB/year</td>
            </tr>
          </tbody>
        </table>
      </div>
...
make --version`} />
      ...
      <div className="not-prose my-6">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-mono">30303</td>
              <td className="px-6 py-4 text-sm">TCP/UDP</td>
              <td className="px-6 py-4 text-sm">Ethereum execution P2P</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-mono">9000</td>
              <td className="px-6 py-4 text-sm">TCP/UDP</td>
              <td className="px-6 py-4 text-sm">Lighthouse consensus P2P</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-mono">13000</td>
              <td className="px-6 py-4 text-sm">TCP</td>
              <td className="px-6 py-4 text-sm">Prysm consensus P2P</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-mono">6060</td>
              <td className="px-6 py-4 text-sm">TCP</td>
              <td className="px-6 py-4 text-sm">Juno RPC (localhost only)</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table className="min-w-full divide-y divide-gray-200">
          <thead className="bg-gray-50">
            <tr>
              ...
              <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Est. Cost/Month</th>
            </tr>
          </thead>
          <tbody className="bg-white divide-y divide-gray-200">
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">AWS</td>
              <td className="px-6 py-4 text-sm">m5.2xlarge + 4TB gp3</td>
              <td className="px-6 py-4 text-sm">~$500-700</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">Google Cloud</td>
              <td className="px-6 py-4 text-sm">n2-standard-8 + 4TB SSD</td>
              <td className="px-6 py-4 text-sm">~$600-800</td>
            </tr>
            <tr>
              <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">Azure</td>
              <td className="px-6 py-4 text-sm">Standard_D8s_v3 + 4TB Premium SSD</td>
              <td className="px-6 py-4 text-sm">~$550-750</td>
            </tr>
          </tbody>
        </table>
      </div>
