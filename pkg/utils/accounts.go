...
func DeployAccount() error {
	...
	requiredAmount, err := displayFundingInfoAndStartMonitoring(client, deployTxn, precomputedAddr)
	if err != nil {
	...
	displayDeploymentResults(resp)

	_ = priv //  TODO return prv key and account address
	return nil
}
...
// displayDeploymentResults shows the deployment transaction results
func displayDeploymentResults(resp *rpc.TransactionResponse) {
